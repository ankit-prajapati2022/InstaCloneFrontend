...
const Profile = () => {
  ...
  const following =
    profile && profile.followers.includes(user && user.username);
  ...
  const length = (link) => {
    if (profile) {
      return profile.profile == "Private"
        ? profile[link]
        : profile[link].length;
    }
    ...
    <div className="profile__container">
                ...
                return (
                  <div className="person">
                    ...
                    <button>
                      {click.control === "following-list"
                        ? "Following"
                        : followList("following-list").includes(person)
                        ? "Following"
                        : "Follow"}
                    </button>
                  </div>
      ...
      <div className="profile_user">
        ...
        <div className="user_info">
          <div>
            <h2>{profile ? profile.username : user ? user.username : ""}</h2>
            {profile ? (
              <div className="follow">
                ...
                <div
                  className={following ? "down-arrow brown-box" : "down-arrow"}
                >
                  <DownArrow />
                </div>
                <ThreeDots />
